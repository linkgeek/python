...
def main():
    ...
    keywords = (
        '有喵酱', '小鸟酱', '苏苏', '工口糯米姬', '押尾猫', "初音", "不见星空",
        '白袜袜格罗丫', '软萌萝莉小仙', '绯红小猫', '恶犬', '香草少女', '沐沐睡不着呀', '呆萌橘子酱', '希希酱',
        '来自喵星的岁酱', '沐儿', '露西宝宝', '闵儿', '原歆公主', '涂鸦少女', '小秋秋',
        '完具', '娜美妖姬', '依灵儿', '比卡丘', '亲亲我吖', '我刚成年', '软糖呀', '有喵酱', '桃桃酱',
        '范冰冰', '橘猫', '九尾狐狸', '奈音', '小清殿下', "喵喵儿", '樱井奈奈', '怪污可优', '悠宝', '械师',
        '夜夜主教', '赛高酱', '貂蝉', '王星雅', '王瑞儿', '姚安琪', 'LEXISCANDYSHOP', '浪味仙儿',
        '三寸', '萌兰酱', '发条', '习呆呆')
    file_name = "keywords2_0516"
    for i in range(1, 50):
