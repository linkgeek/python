...
def main():
    file_name = "keywords1_0605_0606"
    open_browser(file_name)
    exit()

    start_time = time.perf_counter()
    search_end_date = '06-05'
    data = []
    ...
    keywords = ("不见星空", '白袜袜格罗', '押尾猫', '完具酱', '有喵酱', '工口糯米姬',
                ...
                '露西宝宝', '原歆公主', '涂鸦少女', '玩酱呀', '三寸', '软耳奶猫',
                '比卡丘', '亲亲我吖', '我刚成年', '软糖呀', '咬一口小奈樱', '贪吃的小猫',
                '小清殿下', '樱井奈奈', '怪污可优', '械师',
                '夜夜主教', '赛高酱', '貂蝉王星雅', '浪味仙儿', '夏玲蔓', '涵北', '琉璃', '弥漫',
                '来自喵星的岁酱', '橘子酱', "初音", '桃小沫沫酱', '喵喵',
                '铃木美', '可爱的小猫', '小秋秋', '可爱的小胖丁', '奈音',
                '发条', '习呆呆', 'KANAMI', '姚安琪', 'LEXISCANDYSHOP')

    keywords3 = ('黑龙江', '教室', '91汝工作室', '乌克兰', '超粉嫩美鲍', '超正点')
