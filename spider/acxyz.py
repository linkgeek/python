...
def main():
    ...
    keywords1 = ("91汝工作室", '乌克兰', '推特网红', '推特女神', '推特极品', '极品网红', '宅男福利',
                 '私人', '女仆', '超粉嫩美鲍', '骚+浪+贱', '骚 浪 贱')
    keywords = (
        '有喵酱',
        '白袜袜格罗丫', '软萌萝莉小仙', '恶犬', '香草少女', '沐沐睡不着呀',
        '来自喵星的岁酱', '沐儿', '闵儿', "初音", "不见星空", '原歆公主', '涂鸦少女', '你们的小秋秋',
        '完具', '娜美妖姬', '依灵儿', '比卡丘', '亲亲我吖', '我刚成年', '软糖呀', '有喵酱',
        '工口糯米姬', '范冰冰', '橘猫', '九尾狐狸', '奈音', '小清殿下', "喵喵儿", '樱井奈奈', '怪污可优',
        '希希酱', '夜夜主教', '赛高酱', '貂蝉', '王星雅', '王瑞儿', '姚安琪', 'LEXISCANDYSHOP')
    file_name = "111"
    for i in range(1, 6):
