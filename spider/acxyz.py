...
def main():
    file_name = "keywords1_0610_0614"
    open_browser(file_name)
    exit()

    start_time = time.perf_counter()
    search_end_date = '06-10'
    data = []

    keywords = ("91汝", '乌克兰', '推特网红', '推特女神', '推特极品', '宅男福利', '私人玩物', '骚+浪+贱', '骚 浪 贱',
    ...
    keywords2 = ("不见星空", '白袜袜格罗', '押尾猫', '完具酱', '有喵酱', '工口糯米姬',
                 ...
                 '九尾狐狸', '沐沐睡不着呀', '蛋壳姬', '橘猫', '麻酥酥哟',
                 '露西', '原歆公主', '涂鸦少女', '玩酱呀', '三寸', '软耳奶猫',
                 ...
                 '铃木美', '可爱的小猫', '小秋秋', '可爱的小胖丁', '奈音', '妲己', '麻酥酥哟', '玖尾酱',
